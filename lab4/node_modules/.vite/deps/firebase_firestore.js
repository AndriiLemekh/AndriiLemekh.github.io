import { B as isCloudWorkstation, C as LogLevel, D as FirebaseError, I as getGlobal, J as isSafariOrWebkit, L as getModularInstance, P as getDefaultEmulatorHostnameAndPort, R as getUA, T as Component, W as isIndexedDBAvailable, Y as pingServer, c as _getProvider, f as _registerComponent, g as getApp, j as deepEqual, k as createMockUserToken, n as SDK_VERSION, p as _removeServiceInstance, q as isSafari, u as _isFirebaseServerApp, w as Logger, x as registerVersion } from "./index.esm-CZLmQmUT.js";
...
(function() {
	...
	webchannel_blob_es2018.FetchXmlHttpFactory = Ec;
...
//#endregion
//#region node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js
/**
* @license
...
*/ var FieldPath$1 = class FieldPath$1 extends BasePath {
	...
	*/ isKeyField() {
		return 1 === this.length && this.get(0) === "__name__";
	}
	/**
...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		...
		return new Timestamp(t, Math.floor((e - 1e3 * t) * O));
	}
	/**
...
var __PRIVATE_SimpleDbTransaction = class __PRIVATE_SimpleDbTransaction {
	...
	abort(e) {
		e && this.S.reject(e), this.aborted || (__PRIVATE_logDebug(L, "Aborting transaction:", e ? e.message : "Client-initiated abort"), this.aborted = !0, this.transaction.abort());
	}
	C() {
	...
	*/ async L(e) {
		return this.db || (__PRIVATE_logDebug(L, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
			...
			r.onsuccess = (e) => {
				...
				this.N.k(t, r.transaction, e.oldVersion, this.version).next((() => {
					__PRIVATE_logDebug(L, "Database upgrade to version " + this.version + " complete");
				}));
			};
		}))), this.q && (this.db.onversionchange = (e) => this.q(e)), this.db;
	}
	K(e) {
	...
	async runTransaction(e, t, n, r) {
		...
		for (;;) {
			...
			try {
				...
				const t = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s = r(t).next(((e) => (t.C(), e))).catch(((e) => (t.abort(e), PersistencePromise.reject(e)))).toPromise();
				return s.catch((() => {})), await t.D, s;
			} catch (e) {
...
*/ var __PRIVATE_SimpleDbStore = class {
	...
	*/ get(e) {
		return __PRIVATE_wrapRequest(this.store.get(e)).next(((t) => (void 0 === t && (t = null), __PRIVATE_logDebug(L, "GET", this.store.name, e, t), t)));
	}
	delete(e) {
...
var __PRIVATE_IndexBackfillerScheduler = class {
	...
	re(e) {
		__PRIVATE_logDebug(K, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
			this.task = null;
			try {
				__PRIVATE_logDebug(K, `Documents written: ${await this.ne.ie()}`);
			} catch (e) {
				__PRIVATE_isIndexedDbTransactionError(e) ? __PRIVATE_logDebug(K, "Ignoring IndexedDB error during index backfill: ", e) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e);
			}
			await this.re(6e4);
		}));
	}
...
/** Implements the steps for backfilling indexes. */ var __PRIVATE_IndexBackfiller = class {
	...
	/** Writes index entries until the cap is reached. Returns the number of documents processed. */ se(e, t) {
		...
		return PersistencePromise.doWhile((() => !0 === i && r > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(((t) => {
			if (null !== t && !n.has(t)) return __PRIVATE_logDebug(K, `Processing collection: ${t}`), this.oe(e, t, r).next(((e) => {
				r -= e, n.add(t);
			}));
			i = !1;
		})))).next((() => t - r));
	...
	*/ oe(e, t, n) {
		return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next(((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next(((n) => {
			const i = n.changes;
			return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this._e(r, n))).next(((n) => (__PRIVATE_logDebug(K, `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(e, t, n)))).next((() => i.size));
		}))));
	}
...
*/ function __PRIVATE_decodeResourcePath(e) {
	const t = e.length;
	if (__PRIVATE_hardAssert(t >= 2, 64408, { path: e }), 2 === t) return __PRIVATE_hardAssert(e.charAt(0) === U && "" === e.charAt(1), 56145, { path: e }), ResourcePath.emptyPath();
	const __PRIVATE_lastReasonableEscapeIndex = t - 2, n = [];
	let r = "";
	for (let i = 0; i < t;) {
		const t = e.indexOf(U, i);
		(t < 0 || t > __PRIVATE_lastReasonableEscapeIndex) && fail(50515, { path: e });
		switch (e.charAt(t + 1)) {
			case "":
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var $ = "remoteDocuments", W = "owner", Q = "owner", G = "mutationQueues", z = "userId", j = "mutations", H = "batchId", J = "userMutationsIndex", Z = ["userId", "batchId"];
/**
* @license
* Copyright 2022 Google LLC
*
...
* information.
*/ var X = {}, Y = "documentMutations", ee = "remoteDocumentsV14", te = [
	"prefixPath",
	"collectionGroup",
	"readTime",
	"documentId"
	...
	"collectionPath",
	"documentId"
], ke = "collectionPathOverlayIndex", Ke = [
	"userId",
	"collectionPath",
	"largestBatchId"
], qe = "collectionGroupOverlayIndex", Ue = [
	"userId",
	"collectionGroup",
	"largestBatchId"
], $e = "globals", We = "name", Qe = [
	...[...[...[...[
		G,
		j,
		Y,
...
var Ye = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
*   localWriteTime.
*/ var et = "server_timestamp", tt = "__type__", nt = "__previous_value__", rt = "__local_write_time__";
function __PRIVATE_isServerTimestamp(e) {
	return (e?.mapValue?.fields || {})[tt]?.stringValue === et;
}
/**
...
/** The default database name for a project. */ var it = "(default)";
/**
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var st = "__type__", ot = "__max__", _t = { mapValue: { fields: { __type__: { stringValue: ot } } } }, at = "__vector__", ut = "value", ct = { nullValue: "NULL_VALUE" };
...
function __PRIVATE_valueCompare(e, t) {
	...
	switch (n) {
		...
		case 10: return function __PRIVATE_compareVectors(e, t) {
			const n = e.fields || {}, r = t.fields || {}, i = n[ut]?.arrayValue, s = r[ut]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
			if (0 !== o) return o;
			return __PRIVATE_compareArrays(i, s);
		}(e.mapValue, t.mapValue);
		case 11: return function __PRIVATE_compareMaps(e, t) {
			if (e === _t.mapValue && t === _t.mapValue) return 0;
			if (e === _t.mapValue) return 1;
			if (t === _t.mapValue) return -1;
...
/** Returns true if `value` is a VetorValue. */ function __PRIVATE_isVectorValue(e) {
	return (e?.mapValue?.fields || {})[st]?.stringValue === at;
}
...
/** Returns the largest value for the given value type (exclusive). */ function __PRIVATE_valuesGetUpperBound(e) {
	return "nullValue" in e ? { booleanValue: !1 } : "booleanValue" in e ? { doubleValue: NaN } : "integerValue" in e || "doubleValue" in e ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "timestampValue" in e ? { stringValue: "" } : "stringValue" in e ? { bytesValue: "" } : "bytesValue" in e ? __PRIVATE_refValue(DatabaseId.empty(), DocumentKey.empty()) : "referenceValue" in e ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "geoPointValue" in e ? { arrayValue: {} } : "arrayValue" in e ? lt : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? { mapValue: {} } : _t : fail(61959, { value: e });
}
...
function __PRIVATE_canonifyTarget(e) {
	...
	if (null === t.Te) {
		...
		}(e))).join(","), __PRIVATE_isNullOrUndefined(t.limit) || (e += "|l:", e += t.limit), t.startAt && (e += "|lb:", e += t.startAt.inclusive ? "b:" : "a:", e += t.startAt.position.map(((e) => canonicalId(e))).join(",")), t.endAt && (e += "|ub:", e += t.endAt.inclusive ? "a:" : "b:", e += t.endAt.position.map(((e) => canonicalId(e))).join(",")), t.Te = e;
	}
	return t.Te;
}
...
var __PRIVATE_QueryImpl = class {
	...
	*/
	constructor(e, t = null, n = [], r = [], i = null, s = "F", o = null, _ = null) {
		this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.Ee = null, this.Ie = null, this.Re = null, this.startAt, this.endAt;
	}
};
...
*/ function __PRIVATE_queryToAggregateTarget(e) {
	const t = __PRIVATE_debugCast(e);
	return t.Re || (t.Re = __PRIVATE__queryToTarget(t, e.explicitOrderBy)), t.Re;
}
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e, t) {
		...
		return t && __PRIVATE_isServerTimestamp(t) && (t = __PRIVATE_getPreviousValue(t)), t && (n.fields[nt] = t), { mapValue: n };
...
function __PRIVATE_mapCodeFromRpcCode(e) {
	...
	switch (e) {
		case Rt.OK: return D.OK;
		case Rt.CANCELLED: return D.CANCELLED;
		case Rt.UNKNOWN: return D.UNKNOWN;
		case Rt.DEADLINE_EXCEEDED: return D.DEADLINE_EXCEEDED;
		case Rt.RESOURCE_EXHAUSTED: return D.RESOURCE_EXHAUSTED;
		case Rt.INTERNAL: return D.INTERNAL;
		case Rt.UNAVAILABLE: return D.UNAVAILABLE;
		case Rt.UNAUTHENTICATED: return D.UNAUTHENTICATED;
		case Rt.INVALID_ARGUMENT: return D.INVALID_ARGUMENT;
		case Rt.NOT_FOUND: return D.NOT_FOUND;
		case Rt.ALREADY_EXISTS: return D.ALREADY_EXISTS;
		case Rt.PERMISSION_DENIED: return D.PERMISSION_DENIED;
		case Rt.FAILED_PRECONDITION: return D.FAILED_PRECONDITION;
		case Rt.ABORTED: return D.ABORTED;
		case Rt.OUT_OF_RANGE: return D.OUT_OF_RANGE;
		case Rt.UNIMPLEMENTED: return D.UNIMPLEMENTED;
		case Rt.DATA_LOSS: return D.DATA_LOSS;
...
var __PRIVATE_WatchChangeAggregator = class {
	constructor(e) {
		this.Ge = e, this.ze = /* @__PURE__ */ new Map(), this.je = __PRIVATE_mutableDocumentMap(), this.Je = __PRIVATE_documentTargetMap(), this.He = __PRIVATE_documentTargetMap(), this.Ze = new SortedMap(__PRIVATE_primitiveComparator);
	}
	/**
	...
	*/ st(e) {
		...
		if (r) {
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				const r = this._t(t);
				if (r !== n) {
					const n = this.ut(e), i = n ? this.ct(n, e, r) : 1;
					if (0 !== i) {
						this.it(t);
						const e = 2 === i ? "TargetPurposeExistenceFilterMismatchBloom" : "TargetPurposeExistenceFilterMismatch";
						this.Ze = this.Ze.insert(t, e);
					}
					Vt?.o(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e, t, n, r, i) {
						const s = {
							localCacheCount: e,
	...
	*/ Pt(e, t) {
		...
		return n.forEach(((n) => {
			...
			e.mightContain(s) || (this.et(t, n, null), r++);
		})), r;
	}
	/**
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		const r = function __PRIVATE_fromWatchTargetChangeState(e) {
			return "NO_CHANGE" === e ? 0 : "ADD" === e ? 1 : "REMOVE" === e ? 2 : "CURRENT" === e ? 3 : "RESET" === e ? 4 : fail(39313, { state: e });
		...
		if (!("filter" in t)) return fail(11601, { Vt: t });
		{
			t.filter;
			const e = t.filter;
			e.targetId;
...
function toMutation(e, t) {
	...
	if (t instanceof __PRIVATE_SetMutation) n = { update: __PRIVATE_toMutationDocument(e, t.key, t.value) };
		...
		if (!(t instanceof __PRIVATE_VerifyMutation)) return fail(16599, { dt: t.type });
	...
	return t.fieldTransforms.length > 0 && (n.updateTransforms = t.fieldTransforms.map(((e) => function __PRIVATE_toFieldTransform(e, t) {
		...
		throw fail(20930, { transform: t.transform });
	}(0, e)))), t.precondition.isNone || (n.currentDocument = function __PRIVATE_toPrecondition(e, t) {
		return void 0 !== t.updateTime ? { updateTime: __PRIVATE_toVersion(e, t.updateTime) } : void 0 !== t.exists ? { exists: t.exists } : fail(27497);
	}(e, t.precondition)), n;
}
function __PRIVATE_fromMutation(e, t) {
	const n = t.currentDocument ? function __PRIVATE_fromPrecondition(e) {
		...
		let n = null;
		if ("setToServerValue" in t) __PRIVATE_hardAssert("REQUEST_TIME" === t.setToServerValue, 16630, { proto: t }), n = new __PRIVATE_ServerTimestampTransform();
		...
		else "increment" in t ? n = new __PRIVATE_NumericIncrementTransformOperation(e, t.increment) : fail(16584, { proto: t });
...
function __PRIVATE_toListenRequestLabels(e, t) {
	const n = function __PRIVATE_toLabel(e) {
		switch (e) {
			...
			default: return fail(28987, { purpose: e });
		}
	}(t.purpose);
...
function __PRIVATE_fromDbMutationBatch(e, t) {
	const n = (t.baseMutations || []).map(((t) => __PRIVATE_fromMutation(e.yt, t)));
	...
	const r = t.mutations.map(((t) => __PRIVATE_fromMutation(e.yt, t))), i = Timestamp.fromMillis(t.localWriteTimeMs);
...
/** Decodes a DbTarget into TargetData */ function __PRIVATE_fromDbTarget(e) {
	...
	return r = function __PRIVATE_isDocumentQuery(e) {
		...
		return __PRIVATE_hardAssert(1 === t, 1966, { count: t }), __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(__PRIVATE_fromQueryPath(e.documents[0])));
...
*/ var __PRIVATE_IndexedDbDocumentOverlayCache = class __PRIVATE_IndexedDbDocumentOverlayCache {
	...
	*/
	...
	getOverlaysForCollection(e, t, n) {
		...
		return __PRIVATE_documentOverlayStore(e).J(ke, s).next(((e) => {
			for (const t of e) {
	...
	St(e, t) {
		return __PRIVATE_documentOverlayStore(e).put(function __PRIVATE_toDbDocumentOverlay(e, t, n) {
			...
			return {
				...
				overlayMutation: toMutation(e.yt, n.mutation)
			};
...
*/ var __PRIVATE_IndexedDbGlobalsCache = class {
	...
	getSessionToken(e) {
		return this.bt(e).get("sessionToken").next(((e) => {
			const t = e?.value;
...
var __PRIVATE_FirestoreIndexValueWriter = class {
	...
	Ct(e, t) {
		...
		} else "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.kt(e.mapValue, t) : (this.qt(e.mapValue, t), this.Nt(t)) : "arrayValue" in e ? (this.Kt(e.arrayValue, t), this.Nt(t)) : fail(19022, { Ut: e });
	}
	Ot(e, t) {
	...
	qt(e, t) {
		const n = e.fields || {};
		this.Ft(t, 55);
		for (const e of Object.keys(n)) this.Ot(e, t), this.Ct(n[e], t);
	}
	kt(e, t) {
		const n = e.fields || {};
		this.Ft(t, 53);
	...
	/** Writes utf8 bytes into this byte sequence, ascending. */ Zt(e) {
		for (const t of e) {
			...
			if (e < 128) this.Gt(e);
				...
				this.Gt(240 | e >>> 18), this.Gt(128 | 63 & e >>> 12), this.Gt(128 | 63 & e >>> 6), this.Gt(128 | 63 & e);
			}
		}
		this.zt();
	}
	/** Writes utf8 bytes into this byte sequence, descending */ Xt(e) {
		for (const t of e) {
			...
			if (e < 128) this.Jt(e);
				...
				const e = t.codePointAt(0);
				this.Jt(240 | e >>> 18), this.Jt(128 | 63 & e >>> 12), this.Jt(128 | 63 & e >>> 6), this.Jt(128 | 63 & e);
			}
		}
		this.Ht();
	}
...
/** Represents an index entry saved by the SDK in persisted storage. */ var __PRIVATE_IndexEntry = class __PRIVATE_IndexEntry {
	...
	*/ In() {
		...
		return n.set(this.En, 0), t !== e ? n.set([0], this.En.length) : ++n[n.length - 1], new __PRIVATE_IndexEntry(this.hn, this.Pn, this.Tn, n);
	}
	Rn(e, t, n) {
		return {
			indexId: this.hn,
...
*/ function __PRIVATE_encodeKeySafeBytes(e) {
	return isSafariOrWebkit() ? function __PRIVATE_encodeUint8ArrayToSortableString(e) {
		let t = "";
		for (let n = 0; n < e.length; n++) t += String.fromCharCode(e[n]);
		return t;
	}(e) : e;
...
var __PRIVATE_TargetIndexMatcher = class {
	constructor(e) {
		this.Vn = new SortedSet(((e, t) => FieldPath$1.comparator(e.field, t.field))), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.dn = e.orderBy, this.mn = [];
		for (const t of e.filters) {
			const e = t;
			e.isInequality() ? this.Vn = this.Vn.add(e) : this.mn.push(e);
		}
	}
	get fn() {
	...
	*   omitted.
	*/ gn(e) {
		if (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId, 49279), this.fn) return !1;
		const t = __PRIVATE_fieldIndexGetArraySegment(e);
		if (void 0 !== t && !this.pn(t)) return !1;
		...
		if (this.Vn.size > 0) {
			const e = this.Vn.getIterator().getNext();
			if (!r.has(e.field.canonicalString())) {
				const t = n[i];
				if (!this.yn(e, t) || !this.wn(this.dn[s++], t)) return !1;
			}
			++i;
		}
		for (; i < n.length; ++i) {
			const e = n[i];
			if (s >= this.dn.length || !this.wn(this.dn[s++], e)) return !1;
		}
		return !0;
	}
	/**
	...
	*/ Sn() {
		...
		for (const n of this.dn) n.field.isKeyField() || e.has(n.field) || (e = e.add(n.field), t.push(new IndexSegment(n.field, "asc" === n.dir ? 0 : 1)));
		return new FieldIndex(FieldIndex.UNKNOWN_ID, this.collectionId, t, IndexState.empty());
	}
	pn(e) {
		for (const t of this.mn) if (this.yn(t, e)) return !0;
		return !1;
	}
	yn(e, t) {
...
*/ function __PRIVATE_computeInExpansion(e) {
	if (__PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 20012), e instanceof FieldFilter) {
		if (e instanceof __PRIVATE_InFilter) {
			const t = e.value.arrayValue?.values?.map(((t) => FieldFilter.create(e.field, "==", t))) || [];
			return CompositeFilter.create(t, "or");
		}
		return e;
	}
...
function __PRIVATE_computeDistributedNormalForm(e) {
	...
	return n = __PRIVATE_applyAssociation(n), __PRIVATE_isDisjunctiveNormalForm(n) ? n : (__PRIVATE_hardAssert(n instanceof CompositeFilter, 64498), __PRIVATE_hardAssert(__PRIVATE_compositeFilterIsConjunction(n), 40251), __PRIVATE_hardAssert(n.filters.length > 1, 57927), n.filters.reduce(((e, t) => __PRIVATE_applyDistribution(e, t))));
}
function __PRIVATE_applyDistribution(e, t) {
	let n;
	return __PRIVATE_hardAssert(e instanceof FieldFilter || e instanceof CompositeFilter, 38388), __PRIVATE_hardAssert(t instanceof FieldFilter || t instanceof CompositeFilter, 25473), n = e instanceof FieldFilter ? t instanceof FieldFilter ? function __PRIVATE_applyDistributionFieldFilters(e, t) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var yt = "IndexedDbIndexManager", wt = new Uint8Array(0);
/**
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.Dn = new __PRIVATE_MemoryCollectionParentIndex(), this.Cn = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), ((e, t) => __PRIVATE_targetEquals(e, t))), this.uid = e.uid || "";
	}
	/**
	...
	*/ addToCollectionParentIndex(e, t) {
	...
	getCollectionParents(e, t) {
		...
		return __PRIVATE_collectionParentsStore(e).J(r).next(((e) => {
			for (const r of e) {
	...
	createTargetIndexes(e, t) {
		return PersistencePromise.forEach(this.vn(t), ((t) => this.getIndexType(e, t).next(((n) => {
			if (0 === n || 1 === n) {
	...
	getDocumentsMatchingTarget(e, t) {
		...
		return PersistencePromise.forEach(this.vn(t), ((t) => this.Fn(e, t).next(((e) => {
			r && (r = !!e), i.set(t, e);
		})))).next((() => {
			if (r) {
				...
				return PersistencePromise.forEach(i, ((i, s) => {
					__PRIVATE_logDebug(yt, `Using index ${function __PRIVATE_fieldIndexToString(e) {
					...
					const o = function __PRIVATE_targetGetArrayValues(e, t) {
						...
						return new Bound(n, r);
					}(s, i), c = this.Mn(i, s, a), l = this.Mn(i, s, u), h = this.xn(i, s, _), P = this.On(i.indexId, o, c, a.inclusive, l, u.inclusive, h);
					return PersistencePromise.forEach(P, ((i) => n.Z(i, t.limit).next(((t) => {
						t.forEach(((t) => {
	...
	*/ On(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _ = t ? this.Nn(t[c / a]) : wt, l = this.Bn(e, _, n[c % a], r), h = this.Ln(e, _, i[c % a], s), P = o.map(((t) => this.Bn(e, _, t, !0)));
			u.push(...this.createRange(l, h, P));
		}
		return u;
	}
	/** Generates the lower bound for `arrayValue` and `directionalValue`. */ Bn(e, t, n, r) {
		const i = new __PRIVATE_IndexEntry(e, DocumentKey.empty(), t, n);
		return r ? i : i.In();
	}
	/** Generates the upper bound for `arrayValue` and `directionalValue`. */ Ln(e, t, n, r) {
		const i = new __PRIVATE_IndexEntry(e, DocumentKey.empty(), t, n);
		return r ? i.In() : i;
	}
	Fn(e, t) {
		...
		return this.getFieldIndexes(e, r).next(((e) => {
			let t = null;
			for (const r of e) n.gn(r) && (!t || r.fields.length > t.fields.length) && (t = r);
			return t;
		}));
	}
	getIndexType(e, t) {
	...
	*/ kn(e, t) {
		...
		for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			...
			if (null == e) return null;
			const i = n.ln(r.kind);
			__PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e, i);
		}
		return n.un();
	}
	/** Encodes a single value to the ascending index format. */ Nn(e) {
		const t = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e, t.ln(0)), t.un();
	}
	/**
	...
	*/ qn(e, t) {
		const n = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.Wt.Dt(__PRIVATE_refValue(this.databaseId, t), n.ln(function __PRIVATE_fieldIndexGetKeyOrder(e) {
	...
	*/ xn(e, t, n) {
		...
		for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			const e = n[i++];
			for (const n of r) if (this.Kn(t, s.fieldPath) && isArray(e)) r = this.Un(r, s, e);
			else {
				const t = n.ln(s.kind);
				__PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e, t);
			}
		}
		return this.$n(r);
	}
	...
	*/ Mn(e, t, n) {
	...
	/** Returns the byte representation for the provided encoders. */ $n(e) {
		const t = [];
	...
	*/ Un(e, t, n) {
		...
		for (const e of n.arrayValue.values || []) for (const n of r) {
			...
			r.seed(n.un()), __PRIVATE_FirestoreIndexValueWriter.Wt.Dt(e, r.ln(t.kind)), i.push(r);
		}
		return i;
	}
	Kn(e, t) {
	...
	getFieldIndexes(e, t) {
		...
		return (t ? n.J(be, IDBKeyRange.bound(t, t)) : n.J()).next(((e) => {
			const t = [];
	...
	updateCollectionGroup(e, t, n) {
		...
		return this.Wn(e).next(((e) => r.J(be, IDBKeyRange.bound(t, t)).next(((t) => PersistencePromise.forEach(t, ((t) => i.put(__PRIVATE_toDbIndexState(t.indexId, this.uid, e, n))))))));
	}
	updateIndexEntries(e, t) {
		const n = /* @__PURE__ */ new Map();
		return PersistencePromise.forEach(t, ((t, r) => {
			const i = n.get(t.collectionGroup);
			return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t.collectionGroup)).next(((i) => (n.set(t.collectionGroup, i), PersistencePromise.forEach(i, ((n) => this.Qn(e, t, n).next(((t) => {
				const i = this.Gn(r, n);
	...
	Qn(e, t, n) {
		...
		return r.ee({
			...
			range: IDBKeyRange.only([
				n.indexId,
				this.uid,
				__PRIVATE_encodeKeySafeBytes(this.qn(n, t))
			])
		}, ((e, r) => {
	...
	/** Creates the index entries for the given document. */ Gn(e, t) {
		...
		if (null != i) {
			...
			if (isArray(s)) for (const i of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Nn(i), r));
	...
	*/ createRange(e, t, n) {
		...
		for (const i of n) {
			...
			if (0 === n) r[0] = e.In();
			else if (n > 0 && s < 0) r.push(i), r.push(i.In());
			else if (s > 0) break;
		}
		r.push(t);
		const i = [];
		for (let e = 0; e < r.length; e += 2) {
			if (this.Hn(r[e], r[e + 1])) return [];
			const t = r[e].An(this.uid, wt, DocumentKey.empty()), n = r[e + 1].An(this.uid, wt, DocumentKey.empty());
	...
	getMinOffset(e, t) {
		return PersistencePromise.mapArray(this.vn(t), ((t) => this.Fn(e, t).next(((e) => e || fail(44426))))).next(__PRIVATE_getMinOffsetFromFieldIndexes);
	}
};
/**
...
function removeMutationBatch(e, t, n) {
	...
	let _ = 0;
	const a = r.ee({ range: o }, ((e, t, n) => (_++, n.delete())));
	s.push(a.next((() => {
...
var __PRIVATE_IndexedDbMutationQueue = class __PRIVATE_IndexedDbMutationQueue {
	constructor(e, t, n, r) {
		this.userId = e, this.serializer = t, this.indexManager = n, this.referenceDelegate = r, this.Zn = {};
	}
	/**
	...
	addMutationBatch(e, t, n, r) {
		...
		return s.add({}).next(((o) => {
			...
			const _ = new MutationBatch(o, t, n, r), a = function __PRIVATE_toDbMutationBatch(e, t, n) {
				const r = n.baseMutations.map(((t) => toMutation(e.yt, t))), i = n.mutations.map(((t) => toMutation(e.yt, t)));
				return {
					userId: t,
					batchId: n.batchId,
	...
	*/
	Xn(e, t) {
		return this.Zn[t] ? PersistencePromise.resolve(this.Zn[t]) : this.lookupMutationBatch(e, t).next(((e) => {
			if (e) {
				const n = e.keys();
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).ee({
			...
			t.userId === this.userId && (__PRIVATE_hardAssert(t.batchId >= n, 47524, { Yn: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t)), r.done();
		})).next((() => i));
	}
	...
	getAllMutationBatches(e) {
		...
		return __PRIVATE_mutationsStore(e).J(J, t).next(((e) => e.map(((e) => __PRIVATE_fromDbMutationBatch(this.serializer, e)))));
	}
	getAllMutationBatchesAffectingDocumentKey(e, t) {
		const n = __PRIVATE_newDbDocumentMutationPrefixForPath(this.userId, t.path), r = IDBKeyRange.lowerBound(n), i = [];
		return __PRIVATE_documentMutationsStore(e).ee({ range: r }, ((n, r, s) => {
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		const r = [];
		return t.forEach(((t) => {
			const i = __PRIVATE_newDbDocumentMutationPrefixForPath(this.userId, t.path), s = IDBKeyRange.lowerBound(i), o = __PRIVATE_documentMutationsStore(e).ee({ range: s }, ((e, r, i) => {
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		return __PRIVATE_documentMutationsStore(e).ee({ range: s }, ((e, t, i) => {
	...
	tr(e, t) {
		...
		return t.forEach(((t) => {
			r.push(__PRIVATE_mutationsStore(e).get(t).next(((e) => {
				if (null === e) throw fail(35274, { batchId: t });
	...
	*/
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).ee({ range: n }, ((e, t, n) => {
				if (e[0] === this.userId) {
					const t = __PRIVATE_decodeResourcePath(e[1]);
					r.push(t);
				} else n.done();
			})).next((() => {
				__PRIVATE_hardAssert(0 === r.length, 56720, { rr: r.map(((e) => e.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
*/ var __PRIVATE_IndexedDbTargetCache = class {
	...
	allocateTargetId(e) {
		return this.ur(e).next(((t) => {
			return t.highestTargetId = new __PRIVATE_TargetIdGenerator(t.highestTargetId).next(), this.cr(e, t).next((() => t.highestTargetId));
		}));
	}
	getLastRemoteSnapshotVersion(e) {
		return this.ur(e).next(((e) => SnapshotVersion.fromTimestamp(new Timestamp(e.lastRemoteSnapshotVersion.seconds, e.lastRemoteSnapshotVersion.nanoseconds))));
	}
	...
	removeTargetData(e, t) {
		return this.removeMatchingKeysForTargetId(e, t.targetId).next((() => __PRIVATE_targetsStore(e).delete(t.targetId))).next((() => this.ur(e))).next(((t) => (__PRIVATE_hardAssert(t.targetCount > 0, 8065), t.targetCount -= 1, this.cr(e, t))));
	}
	/**
	...
	*/ forEachTarget(e, t) {
	...
	ur(e) {
		return __PRIVATE_globalTargetStore(e).get(Ie).next(((e) => (__PRIVATE_hardAssert(null !== e, 2888), e)));
	}
	cr(e, t) {
	...
	*/ hr(e, t) {
	...
	getTargetCount(e) {
		return this.ur(e).next(((e) => e.targetCount));
	}
	getTargetData(e, t) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Dt = "LruGarbageCollector", Ct = 1048576;
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ wr(e, t) {
		return function __PRIVATE_mutationQueuesContainKey(e, t) {
			let n = !1;
			return __PRIVATE_mutationQueuesStore(e).te(((r) => __PRIVATE_mutationQueueContainsKey(e, r, t).next(((e) => (e && (n = !0), PersistencePromise.resolve(!e)))))).next((() => n));
		}(e, t);
	}
	removeOrphanedDocuments(e, t) {
	...
	*/ yr(e, t) {
		...
		return n.ee({ index: Pe }, (([e, n], { path: s, sequenceNumber: o }) => {
			0 === e ? (i !== __PRIVATE_ListenSequence.ce && t(new DocumentKey(__PRIVATE_decodeResourcePath(r)), i), i = o, r = s) : i = __PRIVATE_ListenSequence.ce;
		})).next((() => {
	...
	*/ vr(e, t) {
	...
	Cr(e, t, n) {
		...
		return __PRIVATE_remoteDocumentsStore(e).ee({
			...
			o && o.isEqual(i) && (n(o, t), o = s.hasNext() ? s.getNext() : null), o ? r.j(__PRIVATE_dbKey(o)) : r.done();
		})).next((() => {
	...
	getDocumentsMatchingQuery(e, t, n, r, i) {
		...
		return __PRIVATE_remoteDocumentsStore(e).J(IDBKeyRange.bound(o, _, !0)).next(((e) => {
			i?.incrementDocumentReadCount(e.length);
			let n = __PRIVATE_mutableDocumentMap();
			for (const i of e) {
				const e = this.br(DocumentKey.fromSegments(i.prefixPath.concat(i.collectionGroup, i.documentId)), i);
	...
	getAllFromCollectionGroup(e, t, n, r) {
		...
		return __PRIVATE_remoteDocumentsStore(e).ee({
			...
			const s = this.br(DocumentKey.fromSegments(t.prefixPath.concat(t.collectionGroup, t.documentId)), t);
	...
	getMetadata(e) {
		return __PRIVATE_documentGlobalStore(e).get(_e).next(((e) => (__PRIVATE_hardAssert(!!e, 20021), e)));
	}
	Sr(e, t) {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Mr = e, this.trackRemovals = t, this.Or = new ObjectMap(((e) => e.toString()), ((e, t) => e.isEqual(t)));
	}
	applyChanges(e) {
		const t = [];
		...
		return this.changes.forEach(((i, s) => {
			...
			if (t.push(this.Mr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
				...
				const n = __PRIVATE_toDbRemoteDocument(this.Mr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
				t.push(this.Mr.addEntry(e, i, n));
			}
		})), r.forEach(((n) => {
			t.push(this.Mr.indexManager.addToCollectionParentIndex(e, n));
		})), t.push(this.Mr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
	}
	getFromCache(e, t) {
		return this.Mr.Dr(e, t).next(((e) => (this.Or.set(t, {
			size: e.size,
			readTime: e.document.readTime
		}), e.document)));
	}
	getAllFromCache(e, t) {
		return this.Mr.vr(e, t).next((({ documents: e, Fr: t }) => (t.forEach(((t, n) => {
			this.Or.set(t, {
				size: n,
...
*/ var LocalDocumentsView = class {
	...
	*/ computeViews(e, t, n, r) {
		...
		})), this.recalculateAndSaveOverlays(e, i).next(((e) => (e.forEach(((e, t) => s.set(e, t))), t.forEach(((e, t) => o.set(e, new OverlayedDocument(t, s.get(e) ?? null)))), o)));
	}
...
*/ var __PRIVATE_ReferenceSet = class {
	constructor() {
		this.kr = new SortedSet(__PRIVATE_DocReference.qr), this.Kr = new SortedSet(__PRIVATE_DocReference.Ur);
	}
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	constructor(e, t) {
		this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Yn = 1, this.Hr = new SortedSet(__PRIVATE_DocReference.qr);
	}
	checkEmpty(e) {
	...
	addMutationBatch(e, t, n, r) {
		...
		for (const t of r) this.Hr = this.Hr.add(new __PRIVATE_DocReference(t.key, i)), this.indexManager.addToCollectionParentIndex(e, t.key.path.popLast());
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
	...
	*/
	constructor(e) {
		this.ti = e, this.docs = function __PRIVATE_documentEntryMap() {
			return new SortedMap(DocumentKey.comparator);
		}(), this.size = 0;
	}
	setIndexManager(e) {
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.ri = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.ii = 0, this.si = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.oi = __PRIVATE_TargetIdGenerator._r();
	}
	forEachTarget(e, t) {
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	constructor(e, t) {
		this._i = {}, this.overlays = {}, this.ai = new __PRIVATE_ListenSequence(0), this.ui = !1, this.ui = !0, this.ci = new __PRIVATE_MemoryGlobalsCache(), this.referenceDelegate = e(this), this.li = new __PRIVATE_MemoryTargetCache(this);
		...
		}(((e) => this.referenceDelegate.hi(e))), this.serializer = new __PRIVATE_LocalSerializer(t), this.Pi = new __PRIVATE_MemoryBundleCache(this.serializer);
	}
	start() {
...
var __PRIVATE_MemoryEagerDelegate = class __PRIVATE_MemoryEagerDelegate {
	constructor(e) {
		this.persistence = e, this.Ri = new __PRIVATE_ReferenceSet(), this.Ai = null;
	}
	static Vi(e) {
...
var __PRIVATE_MemoryLruDelegate = class __PRIVATE_MemoryLruDelegate {
	constructor(e, t) {
		this.persistence = e, this.fi = new ObjectMap(((e) => __PRIVATE_encodeResourcePath(e.path)), ((e, t) => e.isEqual(t))), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
	}
	static Vi(e, t) {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ k(e, t, n, r) {
		...
		n < 1 && r >= 1 && (function __PRIVATE_createPrimaryClientStore(e) {
			...
			e.createObjectStore(G, { keyPath: z });
			e.createObjectStore(j, {
				keyPath: H,
				autoIncrement: !0
			}).createIndex(J, Z, { unique: !0 }), e.createObjectStore(Y);
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e) {
			...
			(function __PRIVATE_createBundlesStore(e) {
				e.createObjectStore(me, { keyPath: fe });
			})(e), function __PRIVATE_createNamedQueriesStore(e) {
				e.createObjectStore(ge, { keyPath: pe });
			}(e);
		}))), n < 12 && r >= 12 && (s = s.next((() => {
			(function __PRIVATE_createDocumentOverlayStore(e) {
				const t = e.createObjectStore(Be, { keyPath: Le });
				t.createIndex(ke, Ke, { unique: !1 }), t.createIndex(qe, Ue, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e) {
			const t = e.createObjectStore(ee, { keyPath: te });
			t.createIndex(ne, re), t.createIndex(ie, se);
		}(e))).next((() => this.bi(e, i))).next((() => e.deleteObjectStore($)))), n < 14 && r >= 14 && (s = s.next((() => this.Di(e, i)))), n < 15 && r >= 15 && (s = s.next((() => function __PRIVATE_createFieldIndex(e) {
			e.createObjectStore(ye, {
				keyPath: we,
				autoIncrement: !0
			}).createIndex(be, Se, { unique: !1 });
			e.createObjectStore(De, { keyPath: Ce }).createIndex(ve, Fe, { unique: !1 });
			e.createObjectStore(Me, { keyPath: xe }).createIndex(Oe, Ne, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e) {
				e.createObjectStore($e, { keyPath: We });
			})(e);
	...
	gi(e) {
		...
		return t.J().next(((t) => PersistencePromise.forEach(t, ((t) => {
			const r = IDBKeyRange.bound([t.userId, q], [t.userId, t.lastAcknowledgedBatchId]);
			return n.J(J, r).next(((n) => PersistencePromise.forEach(n, ((n) => {
	...
	*/ yi(e) {
	...
	wi(e, t) {
		e.createObjectStore(Re, { keyPath: Ae });
		const n = t.store(Re), r = new __PRIVATE_MemoryCollectionParentIndex(), addEntry = (e) => {
			if (r.add(e)) {
		...
		return t.store($).ee({ Y: !0 }, ((e, t) => {
			return addEntry(new ResourcePath(e).popLast());
		})).next((() => t.store(Y).ee({ Y: !0 }, (([e, t, n], r) => {
	...
	Di(e, t) {
		...
		return n.J().next(((e) => {
			...
			return e.forEach(((e) => {
				...
				__PRIVATE_fromDbMutationBatch(this.serializer, e).keys().forEach(((e) => t = t.add(e))), n.set(e.userId, t);
			})), PersistencePromise.forEach(n, ((e, n) => {
				const s = new User(n), o = __PRIVATE_IndexedDbDocumentOverlayCache.wt(this.serializer, s), _ = i.getIndexManager(s);
				return new LocalDocumentsView(r, __PRIVATE_IndexedDbMutationQueue.wt(s, this.serializer, _, i.referenceDelegate), o, _).recalculateAndSaveOverlaysForDocumentKeys(new __PRIVATE_IndexedDbTransaction(t, __PRIVATE_ListenSequence.ce), e).next();
			}));
		}));
	}
};
function __PRIVATE_createQueryCache(e) {
	e.createObjectStore(le, { keyPath: he }).createIndex(Pe, Te, { unique: !0 });
	e.createObjectStore(ae, { keyPath: "targetId" }).createIndex(ue, ce, { unique: !0 }), e.createObjectStore(Ee);
}
var vt = "IndexedDbPersistence", Ft = 18e5, Mt = 5e3, xt = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ot = "main";
/**
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Ci = i, this.window = s, this.document = o, this.Fi = a, this.Mi = u, this.xi = c, this.ai = null, this.ui = !1, this.isPrimary = !1, this.networkEnabled = !0, this.Oi = null, this.inForeground = !1, this.Ni = null, this.Bi = null, this.Li = Number.NEGATIVE_INFINITY, this.ki = (e) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
		this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.qi = t + Ot, this.serializer = new __PRIVATE_LocalSerializer(_), this.Ki = new __PRIVATE_SimpleDb(this.qi, this.xi, new __PRIVATE_SchemaConverter(this.serializer)), this.ci = new __PRIVATE_IndexedDbGlobalsCache(), this.li = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.Pi = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ui = this.window.localStorage : (this.Ui = null, !1 === u && __PRIVATE_logError(vt, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
	}
	/**
	...
	*/ start() {
		return this.$i().then((() => {
			if (!this.isPrimary && !this.allowTabSynchronization) throw new FirestoreError(D.FAILED_PRECONDITION, xt);
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ setNetworkEnabled(e) {
		this.networkEnabled !== e && (this.networkEnabled = e, this.Ci.enqueueAndForget((async () => {
	...
	*/ $i() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
			...
			if (this.isPrimary) return this.ji(e).next(((e) => {
				e || (this.isPrimary = !1, this.Ci.enqueueRetryable((() => this.ki(!1))));
			}));
		})).next((() => this.Ji(e))).next(((t) => this.isPrimary && !t ? this.Hi(e).next((() => !1)) : !!t && this.Zi(e).next((() => !0)))))).catch(((e) => {
			if (__PRIVATE_isIndexedDbTransactionError(e)) return __PRIVATE_logDebug(vt, "Failed to extend owner lease: ", e), this.isPrimary;
			if (!this.allowTabSynchronization) throw e;
			return __PRIVATE_logDebug(vt, "Releasing owner lease after error during lease refresh", e), !1;
		})).then(((e) => {
			this.isPrimary !== e && this.Ci.enqueueRetryable((() => this.ki(e))), this.isPrimary = e;
		}));
	}
	ji(e) {
		return __PRIVATE_primaryClientStore(e).get(Q).next(((e) => PersistencePromise.resolve(this.Xi(e))));
	}
	Yi(e) {
	...
	*/ async es() {
		if (this.isPrimary && !this.ts(this.Li, Ft)) {
			...
			const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e) => {
				const t = __PRIVATE_getStore(e, Ve);
				return t.J().next(((e) => {
					const n = this.ns(e, Ft), r = e.filter(((e) => -1 === n.indexOf(e)));
	...
	*/ Gi() {
	...
	/** Checks whether `client` is the local client. */ Xi(e) {
	...
	*/ Ji(e) {
		if (this.Mi) return PersistencePromise.resolve(!0);
		return __PRIVATE_primaryClientStore(e).get(Q).next(((t) => {
			if (null !== t && this.ts(t.leaseTimestampMs, Mt) && !this.ss(t.ownerId)) {
				...
				if (!this.Xi(t)) {
					if (!t.allowTabSynchronization) throw new FirestoreError(D.FAILED_PRECONDITION, xt);
					return !1;
				}
			}
			return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).J().next(((e) => void 0 === this.ns(e, Mt).find(((e) => {
	...
	async shutdown() {
		this.ui = !1, this._s(), this.Bi && (this.Bi.cancel(), this.Bi = null), this.us(), this.cs(), await this.Ki.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
			const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.ce);
			return this.Hi(t).next((() => this.Yi(t)));
		})), this.Ki.close(), this.ls();
	}
	/**
	* Returns clients that are not zombied and have an updateTime within the
	* provided threshold.
	*/ ns(e, t) {
		return e.filter(((e) => this.ts(e.updateTimeMs, t) && !this.ss(e.clientId)));
	}
	/**
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ hs() {
		return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).J().next(((e) => this.ns(e, Ft).map(((e) => e.clientId))))));
	}
	get started() {
		return this.ui;
	}
	...
	runTransaction(e, t, n) {
		...
		const r = "readonly" === t ? "readonly" : "readwrite", i = function __PRIVATE_getObjectStores(e) {
			return 18 === e ? Xe : 17 === e ? Ze : 16 === e ? Je : 15 === e ? He : 14 === e ? je : 13 === e ? ze : 12 === e ? Ge : 11 === e ? Qe : void fail(60245);
		}(this.xi);
		let s;
		return this.Ki.runTransaction(e, r, i, ((r) => (s = new __PRIVATE_IndexedDbTransaction(r, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e) => !!e || this.Ji(s))).next(((t) => {
			if (!t) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = !1, this.Ci.enqueueRetryable((() => this.ki(!1))), new FirestoreError(D.FAILED_PRECONDITION, B);
			return n(s);
		})).next(((e) => this.Zi(s).next((() => e)))) : this.Ps(s).next((() => n(s)))))).then(((e) => (s.raiseOnCommittedEvent(), e)));
	}
	/**
	...
	*/
	Ps(e) {
		return __PRIVATE_primaryClientStore(e).get(Q).next(((e) => {
			if (null !== e && this.ts(e.leaseTimestampMs, Mt) && !this.ss(e.ownerId) && !this.Xi(e) && !(this.Mi || this.allowTabSynchronization && e.allowTabSynchronization)) throw new FirestoreError(D.FAILED_PRECONDITION, xt);
		}));
	}
	/**
	...
	*/ Zi(e) {
	...
	/** Checks the primary lease and removes it if we are the current primary. */ Hi(e) {
		const t = __PRIVATE_primaryClientStore(e);
		return t.get(Q).next(((e) => this.Xi(e) ? (__PRIVATE_logDebug(vt, "Releasing primary lease."), t.delete(Q)) : PersistencePromise.resolve()));
	}
	...
	*/ Qi() {
		"function" == typeof this.window?.addEventListener && (this.Oi = () => {
			...
			isSafari() && (navigator.appVersion.match(e) || navigator.userAgent.match(e)) && this.Ci.enterRestrictedMode(!0), this.Ci.enqueueAndForget((() => this.shutdown()));
	...
	*/ _s() {
	...
	/** Removes the zombied client entry if it exists. */ ls() {
		if (this.Ui) try {
...
var __PRIVATE_QueryEngine = class {
	constructor() {
		this.Rs = !1, this.As = !1, this.Vs = 100, this.ds = function __PRIVATE_getDefaultRelativeIndexReadCostPerDocument() {
	...
	*/ gs(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r) => {
			...
			return this.fs.getDocuments(e, i).next(((r) => this.indexManager.getMinOffset(e, n).next(((n) => {
				const s = this.Ss(t, r);
				return this.bs(t, s, i, n.readTime) ? this.gs(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.Ds(e, s, t, n);
			}))));
		})))));
	}
	/**
	...
	*/ ps(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.fs.getDocuments(e, n).next(((i) => {
			const s = this.Ss(t, i);
			return this.bs(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.Ds(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, N)).next(((e) => e)));
		}));
	}
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Cs = t, this.serializer = r, this.vs = new SortedMap(__PRIVATE_primitiveComparator), this.Fs = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.Ms = /* @__PURE__ */ new Map(), this.xs = e.getRemoteDocumentCache(), this.li = e.getTargetCache(), this.Pi = e.getBundleCache(), this.Os(n);
	}
	Os(e) {
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((e) => {
		const r = t.batch.keys(), i = n.xs.newChangeBuffer({ trackRemovals: !0 });
		return function __PRIVATE_applyWriteToRemoteDocuments(e, t, n, r) {
			...
			return s.forEach(((e) => {
				o = o.next((() => r.getEntry(t, e))).next(((t) => {
					...
					__PRIVATE_hardAssert(null !== s, 48541), t.version.compareTo(s) < 0 && (i.applyToRemoteDocument(t, n), t.isValidDocument() && (t.setReadTime(n.commitVersion), r.addEntry(t)));
				}));
...
*/ function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		const s = n.xs.newChangeBuffer({ trackRemovals: !0 });
		i = n.vs;
		const o = [];
		t.targetChanges.forEach(((s, _) => {
			...
			null !== t.targetMismatches.get(_) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s.resumeToken, r)), i = i.insert(_, u), function __PRIVATE_shouldPersistTargetData(e, t, n) {
				...
				if (t.snapshotVersion.toMicroseconds() - e.snapshotVersion.toMicroseconds() >= Bt) return !0;
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e) => {
		let r;
		return n.li.getTargetData(e, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.li.allocateTargetId(e).next(((i) => (r = new TargetData(t, i, "TargetPurposeListen", e.currentSequenceNumber), n.li.addTargetData(e, r).next((() => r)))))));
	})).then(((e) => {
		const r = n.vs.get(e.targetId);
		return (null === r || e.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.vs = n.vs.insert(e.targetId, e), n.Fs.set(t, e.targetId)), e;
	}));
}
/**
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
	...
	return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", ((e) => r.At(e, t).next(((e) => e ? e.target : null))));
}
/**
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e) => n.xs.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, N), Number.MAX_SAFE_INTEGER))).then(((e) => (__PRIVATE_setMaxReadTime(n, t, e), e)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	for (const e of n) {
		const n = t.qs(e.metadata.name);
		e.document && (s = s.add(n));
		const r = t.Ks(e);
		r.setReadTime(t.Us(e.metadata.readTime)), o = o.insert(n, r);
	}
	const _ = i.xs.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e) {
		return __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(ResourcePath.fromString(`__bundle__/docs/${e}`)));
	}(r));
	return i.persistence.runTransaction("Apply bundle documents", "readwrite", ((e) => __PRIVATE_populateDocumentChangeBuffer(e, _, o).next(((t) => (_.apply(e), t))).next(((t) => i.li.removeMatchingKeysForTargetId(e, a.targetId).next((() => i.li.addMatchingKeys(e, s, a.targetId))).next((() => i.localDocuments.getLocalViewOfDocuments(e, t.Bs, t.Ls))).next((() => t.Bs))))));
}
/**
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
	...
	return i.persistence.runTransaction("Save named query", "readwrite", ((e) => {
		...
		if (r.snapshotVersion.compareTo(s) >= 0) return i.Pi.saveNamedQuery(e, t);
		const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
		return i.vs = i.vs.insert(o.targetId, o), i.li.updateTargetData(e, o).next((() => i.li.removeMatchingKeysForTargetId(e, r.targetId))).next((() => i.li.addMatchingKeys(e, n, r.targetId))).next((() => i.Pi.saveNamedQuery(e, t)));
	}));
}
/**
* @license
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		this.window = e, this.Ci = t, this.persistenceKey = n, this.zs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.js = this.Js.bind(this), this.Hs = new SortedMap(__PRIVATE_primitiveComparator), this.started = !1, this.Zs = [];
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.Xs = createWebStorageClientStateKey(this.persistenceKey, this.zs), this.Ys = function createWebStorageSequenceNumberKey(e) {
			return `firestore_sequence_number_${e}`;
		}(this.persistenceKey), this.Hs = this.Hs.insert(this.zs, new __PRIVATE_LocalClientState()), this.eo = new RegExp(`^${Lt}_${s}_([^_]*)$`), this.no = new RegExp(`^${kt}_${s}_(\\d+)(?:_(.*))?$`), this.ro = new RegExp(`^${Kt$1}_${s}_(\\d+)$`), this.io = function createWebStorageOnlineStateKey(e) {
			return `firestore_online_state_${e}`;
		}(this.persistenceKey), this.so = function createBundleLoadedKey(e) {
			return `firestore_bundle_loaded_v2_${e}`;
		}(this.persistenceKey), this.window.addEventListener("storage", this.js);
	}
	...
	async start() {
		...
		for (const e of this.Zs) this.Js(e);
		this.Zs = [], this.window.addEventListener("pagehide", (() => this.shutdown())), this.started = !0;
	}
	...
	addLocalQueryTarget(e, t = !0) {
		...
		if (this.isActiveQueryTarget(e)) {
			...
			if (t) {
				const r = __PRIVATE_QueryTargetMetadata.$s(e, t);
				r && (n = r.state);
			}
		}
	...
	shutdown() {
		this.started && (this.window.removeEventListener("storage", this.js), this.removeItem(this.Xs), this.started = !1);
	}
	getItem(e) {
				...
				if (this.started) {
					if (null !== t.key) {
						if (this.eo.test(t.key)) {
							if (null == t.newValue) {
								const e = this.Io(t.key);
								return this.Ro(e, null);
							}
							{
								const e = this.Ao(t.key, t.newValue);
								if (e) return this.Ro(e.clientId, e);
							}
						} else if (this.no.test(t.key)) {
							if (null !== t.newValue) {
								const e = this.Vo(t.key, t.newValue);
								if (e) return this.mo(e);
							}
						} else if (this.ro.test(t.key)) {
							if (null !== t.newValue) {
								const e = this.fo(t.key, t.newValue);
								if (e) return this.po(e);
							}
						} else if (t.key === this.io) {
							if (null !== t.newValue) {
								const e = this._o(t.newValue);
								if (e) return this.ao(e);
							}
						} else if (t.key === this.Ys) {
							const e = function __PRIVATE_fromWebStorageSequenceNumber(e) {
								let t = __PRIVATE_ListenSequence.ce;
								if (null != e) try {
									const n = JSON.parse(e);
									__PRIVATE_hardAssert("number" == typeof n, 30636, { yo: e }), t = n;
								} catch (e) {
									__PRIVATE_logError(qt, "Failed to read sequence number from WebStorage", e);
								}
								return t;
							}(t.newValue);
							e !== __PRIVATE_ListenSequence.ce && this.sequenceNumberHandler(e);
						} else if (t.key === this.so) {
							const e = this.wo(t.newValue);
							await Promise.all(e.map(((e) => this.syncEngine.So(e))));
						}
					}
				} else this.Zs.push(t);
			}));
...
var __PRIVATE_RestConnection = class {
	...
	Wo(e, t, n, r, i) {
		...
		return this.zo(e, o, _, n, c).then(((t) => (__PRIVATE_logDebug(Wt, `Received RPC '${e}' ${s}: `, t), t)), ((t) => {
			throw __PRIVATE_logWarn(Wt, `RPC '${e}' ${s} failed with error: `, t, "url: ", o, "request:", n), t;
		}));
	}
	jo(e, t, n, r, i, s) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Gt = "WebChannelConnection", __PRIVATE_unguardedEventListen = (e, t, n) => {
	e.listen(t, ((e) => {
		try {
			n(e);
		} catch (e) {
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	...
	*/ static u_() {
		if (!__PRIVATE_WebChannelConnection.c_) __PRIVATE_unguardedEventListen(getStatEventTarget(), Event.STAT_EVENT, ((e) => {
	...
	T_(e, t, n) {
		const r = __PRIVATE_generateUniqueDebugId(), i = [
			...
			e,
			"/channel"
		], s = this.createWebChannelTransport(), o = {
		...
		void 0 !== _ && (o.longPollingTimeout = Math.round(1e3 * _)), this.useFetchStreams && (o.useFetchStreams = !0), this.Go(o.initMessageHeaders, t, n), o.encodeInitMessageHeaders = !0;
		const a = i.join("");
		...
		const h = new __PRIVATE_StreamBridge({
			Jo: (t) => {
				l ? __PRIVATE_logDebug(Gt, `Not sending because RPC '${e}' stream ${r} is closed:`, t) : (c || (__PRIVATE_logDebug(Gt, `Opening RPC '${e}' stream ${r} transport.`), u.open(), c = !0), __PRIVATE_logDebug(Gt, `RPC '${e}' stream ${r} sending:`, t), u.send(t));
			},
			Ho: () => u.close()
		});
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			...
			l || (l = !0, __PRIVATE_logDebug(Gt, `RPC '${e}' stream ${r} transport closed`), h.o_(), this.I_(u));
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.ERROR, ((t) => {
			l || (l = !0, __PRIVATE_logWarn(Gt, `RPC '${e}' stream ${r} transport errored. Name:`, t.name, "Message:", t.message), h.o_(new FirestoreError(D.UNAVAILABLE, "The operation could not be completed")));
			...
			if (!l) {
				...
				if (s) {
					...
					"NOT_FOUND" === t && i.includes("database") && i.includes("does not exist") && i.includes(this.databaseId.database) && __PRIVATE_logWarn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`), void 0 === n && (n = D.INTERNAL, i = "Unknown error status: " + t + " with message " + s.message), l = !0, h.o_(new FirestoreError(n, i)), u.close();
...
var __PRIVATE_ExponentialBackoff = class {
	...
	*/ p_(e) {
		...
		r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.d_} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.m_ = this.Ci.enqueueAfterDelay(this.timerId, r, (() => (this.f_ = Date.now(), e()))), this.d_ *= this.A_, this.d_ < this.R_ && (this.d_ = this.R_), this.d_ > this.V_ && (this.d_ = this.V_);
	}
	w_() {
...
var __PRIVATE_PersistentStream = class {
	constructor(e, t, n, r, i, s, o, _) {
		this.Ci = e, this.S_ = n, this.b_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.D_ = 0, this.C_ = null, this.v_ = null, this.stream = null, this.F_ = 0, this.M_ = new __PRIVATE_ExponentialBackoff(e, t);
	}
	/**
	...
	*/ W_() {}
	...
	z_(e) {
		return __PRIVATE_logDebug(zt$1, `close with error: ${e}`), this.stream = null, this.close(4, e);
	}
	/**
	...
	*/ Q_(e) {
		return (t) => {
			this.Ci.enqueueAndForget((() => this.D_ === e ? t() : (__PRIVATE_logDebug(zt$1, "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve())));
		};
	}
};
/**
...
*/ var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
	...
	*/ Z_(e) {
		...
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e, t) {
			let n;
			const r = t.target;
			if (n = __PRIVATE_targetIsDocumentTarget(r) ? { documents: __PRIVATE_toDocumentsTarget(e, r) } : { query: __PRIVATE_toQueryTarget(e, r).ft }, n.targetId = t.targetId, t.resumeToken.approximateByteSize() > 0) {
	...
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ea = /* @__PURE__ */ new Map(), this.Ia = /* @__PURE__ */ new Set(), this.Ra = [], this.Aa = i, this.Aa.Mo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(jt, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.Ia.add(4), await __PRIVATE_disableNetworkInternal(t), t.Va.set("Unknown"), t.Ia.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
...
async function __PRIVATE_enableNetworkInternal(e) {
	if (__PRIVATE_canUseNetwork(e)) for (const t of e.Ra) await t(!0);
}
/**
* Temporarily disables the network. The network can be re-enabled using
* enableNetwork().
*/ async function __PRIVATE_disableNetworkInternal(e) {
	for (const t of e.Ra) await t(!1);
}
/**
...
function __PRIVATE_remoteStoreListen(e, t) {
	const n = __PRIVATE_debugCast(e);
	n.Ea.has(t.targetId) || (n.Ea.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).O_() && __PRIVATE_sendWatchRequest(n, t));
}
/**
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	n.Ea.delete(t), r.O_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.Ea.size && (r.O_() ? r.L_() : __PRIVATE_canUseNetwork(n) && n.Va.set("Unknown"));
}
/**
...
async function __PRIVATE_onWatchStreamClose(e, t) {
	__PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.Va.ha(t), __PRIVATE_startWatchStream(e)) : e.Va.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Va.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		/** Handles an error on a target */
		await async function __PRIVATE_handleTargetError(e, t) {
			const n = t.cause;
			for (const r of t.targetIds) e.Ea.has(r) && (await e.remoteSyncer.rejectListen(r, n), e.Ea.delete(r), e.da.removeTarget(r));
		}(e, t);
	} catch (n) {
		__PRIVATE_logDebug(jt, "Failed to remove targets %s: %s ", t.targetIds.join(","), n), await __PRIVATE_disableNetworkUntilRecovery(e, n);
	}
		...
		n.compareTo(t) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e, t) {
			...
			return n.targetChanges.forEach(((n, r) => {
				...
				const r = e.Ea.get(t);
				if (!r) return;
				e.Ea.set(t, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e, t);
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.Ia.add(1), await __PRIVATE_disableNetworkInternal(e), e.Va.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(jt, "Retrying IndexedDB access"), await n(), e.Ia.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Y_ && await async function __PRIVATE_handleWriteError(e, t) {
		if (function __PRIVATE_isPermanentWriteError(e) {
			return __PRIVATE_isPermanentError(e) && e !== D.ABORTED;
		}(t.code)) {
			const n = e.Ta.shift();
			__PRIVATE_ensureWriteStream(e).B_(), await __PRIVATE_executeWithRecovery(e, (() => e.remoteSyncer.rejectFailedWrite(n.batchId, t))), await __PRIVATE_fillWritePipeline(e);
		}
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.Ia.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.Va.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.Ia.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
* Toggles the network state when the client gains or loses its primary lease.
*/ async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	t ? (n.Ia.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.Ia.add(2), await __PRIVATE_disableNetworkInternal(n), n.Va.set("Unknown"));
}
/**
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.ma || (e.ma = function __PRIVATE_newPersistentWatchStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		t ? (e.ma.B_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.Va.set("Unknown")) : (await e.ma.stop(), __PRIVATE_cleanUpWatchStreamState(e));
	}))), e.ma;
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.fa || (e.fa = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		t ? (e.fa.B_(), await __PRIVATE_fillWritePipeline(e)) : (await e.fa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(jt, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
	}))), e.fa;
}
/**
* @license
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		...
		e >= 0 && (s.Sa.splice(e, 1), 0 === s.Sa.length ? i = t.Da() ? 0 : 1 : !s.ba() && t.Da() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e of t) {
		...
		if (i) {
			for (const t of i.Sa) t.Fa(e) && (r = !0);
			i.wa = e;
		}
	}
...
(Jt = Ht$1 || (Ht$1 = {})).Ma = "default", Jt.Cache = "cache";
/**
...
*/ var __PRIVATE_BundleConverterImpl = class {
	...
	*/ Ks(e) {
		return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, !1) : MutableDocument.newNoDocument(this.qs(e.metadata.name), this.Us(e.metadata.readTime));
	}
	Us(e) {
...
*/ var __PRIVATE_BundleLoader = class {
	constructor(e, t) {
		this.$a = e, this.serializer = t, this.Wa = [], this.Qa = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
	}
	/**
	...
	*/ Ga(e) {
		...
		if (e.Ka.namedQuery) this.Wa.push(e.Ka.namedQuery);
			...
			this.Qa.push({ metadata: e.Ka.documentMetadata }), e.Ka.documentMetadata.exists || ++t;
	...
	*/ async ja(e) {
		...
		for (const t of this.Wa) await __PRIVATE_localStoreSaveNamedQuery(e, t, n.get(t.name));
...
*/ var __PRIVATE_View = class {
	constructor(e, t) {
		this.query = e, this.Za = t, this.Xa = null, this.hasCachedResults = !1, this.current = !1, this.Ya = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.eu = __PRIVATE_newQueryComparator(e), this.tu = new DocumentSet(this.eu);
	}
	/**
		...
		s.sort(((e, t) => function __PRIVATE_compareChangeType(e, t) {
			const order = (e) => {
				switch (e) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return fail(20277, { Vt: e });
				}
			};
			return order(e) - order(t);
		}(e.type, t.type) || this.eu(e.doc, t.doc))), this.ou(n), r = r ?? !1;
		const o = t && !r ? this._u() : [], _ = 0 === this.Ya.size && this.current && !r ? 1 : 0, a = _ !== this.Xa;
		if (this.Xa = _, 0 !== s.length || a) return {
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap(((e) => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.Eu = /* @__PURE__ */ new Map(), this.Iu = /* @__PURE__ */ new Set(), this.Ru = new SortedMap(DocumentKey.comparator), this.Au = /* @__PURE__ */ new Map(), this.Vu = new __PRIVATE_ReferenceSet(), this.du = {}, this.mu = /* @__PURE__ */ new Map(), this.fu = __PRIVATE_TargetIdGenerator.ar(), this.onlineState = "Unknown", this.gu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.gu;
	}
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.pu = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.ru(n);
		i.bs && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view.ru(e, i))));
	...
	const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, !0), o = new __PRIVATE_View(t, s.ks), _ = o.ru(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(_, e.isPrimaryClient, a);
...
/** Stops listening to the query. */ async function __PRIVATE_syncEngineUnlisten(e, t, n) {
	...
	if (s.length > 1) return r.Eu.set(i.targetId, s.filter(((e) => !__PRIVATE_queryEquals(e, t)))), void r.Tu.delete(t);
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e, t) => {
			const r = n.Au.get(t);
			r && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1, 22616), e.addedDocuments.size > 0 ? r.hu = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.hu, 14607) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.hu, 42227), r.hu = !1));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Tu.forEach(((n, r) => {
			...
			n.queries.forEach(((e, n) => {
				for (const e of n.Sa) e.va(t) && (r = !0);
			})), r && __PRIVATE_raiseSnapshotsInSyncEvent(n);
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, n)), r.Ru = r.Ru.remove(s), r.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
	...
	try {
		const e = await function __PRIVATE_localStoreRejectBatch(e, t) {
			...
			return n.persistence.runTransaction("Reject batch", "readwrite-primary", ((e) => {
				let r;
				return n.mutationQueue.lookupMutationBatch(e, t).next(((t) => (__PRIVATE_hardAssert(null !== t, 37113), r = t.keys(), n.mutationQueue.removeMutationBatch(e, t)))).next((() => n.mutationQueue.performConsistencyCheck(e))).next((() => n.documentOverlayCache.removeOverlaysForBatchId(e, r, t))).next((() => n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e, r))).next((() => n.localDocuments.getDocuments(e, r)));
			}));
		}(r.localStore, t);
...
*/ async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
	...
	try {
		...
		if (e === q) return void t.resolve();
		const r = n.mu.get(e) || [];
		r.push(t), n.mu.set(e, r);
	} catch (e) {
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	if (e.Eu.delete(t), e.isPrimaryClient) e.Vu.Gr(t).forEach(((t) => {
		e.Vu.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Vu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
		...
		e.Vu.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	...
	r.Tu.isEmpty() || (r.Tu.forEach(((e, _) => {
		o.push(r.pu(_, t, n).then(((e) => {
			...
			if (e) {
				i.push(e);
				const t = __PRIVATE_LocalViewChanges.Is(_.targetId, e);
				s.push(t);
			}
		})));
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		...
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e.removedBatchIds, e.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.Ns);
	}
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e, t) {
		...
		return n.persistence.runTransaction("Lookup mutation documents", "readonly", ((e) => r.Xn(e, t).next(((t) => t ? n.localDocuments.getDocuments(e, t) : PersistencePromise.resolve(null)))));
	}(i.localStore, t);
	...
	}(i.localStore, t)) : fail(6720, "Unknown batchState", { Su: n }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(Zt, "Cannot apply mutation batch with id: " + t);
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	...
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.gu) {
		...
		n.Eu.forEach(((r, i) => {
			...
			})), t.Vu.zr(), t.Au = /* @__PURE__ */ new Map(), t.Ru = new SortedMap(DocumentKey.comparator);
...
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
	...
	for (const e of t) {
		...
		if (n && 0 !== n.length) {
			...
			for (const e of n) {
				const n = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, r.Tu.get(e));
...
function __PRIVATE_syncEngineGetActiveClients(e) {
	return function __PRIVATE_localStoreGetActiveClients(e) {
		return __PRIVATE_debugCast(__PRIVATE_debugCast(e).persistence).hs();
	}(__PRIVATE_debugCast(e).localStore);
}
/** Applies a query target change from a different tab. */
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e);
	if (i.gu) return void __PRIVATE_logDebug(Zt, "Ignoring unexpected query state notification.");
	const s = i.Eu.get(t);
...
/** Adds or removes Watch targets for queries from different tabs. */ async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
	...
	if (r.gu) {
		for (const e of t) {
			if (r.Eu.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
				__PRIVATE_logDebug(Zt, "Adding an already active target " + e);
				continue;
			}
		...
		for (const e of n) r.Eu.has(e) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e, !1).then((() => {
	...
	(async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			if (await function __PRIVATE_localStoreHasNewerBundle(e, t) {
				...
				return n.persistence.runTransaction("hasNewerBundle", "readonly", ((e) => n.Pi.getBundleMetadata(e, t.id))).then(((e) => !!e && e.createTime.compareTo(r) >= 0));
			...
			let s = await t.bu();
			for (; s;) {
				const e = await i.Ga(s);
				e && n._updateProgress(e), s = await t.bu();
			}
			const o = await i.ja(e.localStore);
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, o.Ha, void 0), await function __PRIVATE_localStoreSaveBundle(e, t) {
				const n = __PRIVATE_debugCast(e);
				return n.persistence.runTransaction("Save bundle", "readwrite", ((e) => n.Pi.saveBundleMetadata(e, t)));
			}(e.localStore, r), n._completeWith(o.progress), Promise.resolve(o.Ja);
		} catch (e) {
			return __PRIVATE_logWarn(Zt, `Loading bundle failed with ${e}`), n._failWith(e), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e) => {
...
*/ var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	...
	async initialize(e) {
		await super.initialize(e), await this.xu.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.xu.syncEngine), await __PRIVATE_fillWritePipeline(this.xu.remoteStore), await this.persistence.zi((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
	}
	vu(e) {
		return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
	}
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	...
	async initialize(e) {
		...
		}, await this.sharedClientState.start()), await this.persistence.zi((async (e) => {
			await __PRIVATE_syncEngineApplyPrimaryState(this.xu.syncEngine, e), this.gcScheduler && (e && !this.gcScheduler.started ? this.gcScheduler.start() : e || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e || this.indexBackfillerScheduler.stop());
		}));
	}
	Du(e) {
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(jt, "RemoteStore shutting down."), t.Ia.add(5), await __PRIVATE_disableNetworkInternal(t), t.Aa.shutdown(), t.Va.set("Unknown");
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Bu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Lu = function __PRIVATE_newTextDecoder() {
			...
			e && e.Ua() ? this.metadata.resolve(e.Ka.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e?.Ka)}`));
	...
	*/ async ku() {
	...
	/** First index of '{' from the underlying buffer. */ $u() {
	...
	*/ async qu() {
		for (; this.$u() < 0;) if (await this.Wu()) break;
	...
	*/ async Uu(e) {
		for (; this.buffer.length < e;) await this.Wu() && this.Ku("Reached the end of bundle when more is expected.");
...
var Transaction$2 = class {
	...
	async lookup(e) {
		...
		const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
			const n = __PRIVATE_debugCast(e), r = { documents: t.map(((e) => __PRIVATE_toName(n.serializer, e))) }, i = await n.jo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t.length), s = /* @__PURE__ */ new Map();
			i.forEach(((e) => {
			...
			return t.forEach(((e) => {
				...
				__PRIVATE_hardAssert(!!t, 55234, { key: e }), o.push(t);
			})), o;
		}(this.datastore, e);
...
var FirestoreClient = class {
	constructor(e, t, n, r, i) {
		this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this._databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (async (e) => {
			__PRIVATE_logDebug(Xt$1, "Received user=", e.uid), await this.authCredentialListener(e), this.user = e;
		})), this.appCheckCredentials.start(n, ((e) => (__PRIVATE_logDebug(Xt$1, "Received new app check token=", e), this.appCheckCredentialListener(e, this.user))));
	}
	get configuration() {
		return {
...
async function __PRIVATE_setOfflineComponentProvider(e, t) {
	e.asyncQueue.verifyOperationInProgress(), __PRIVATE_logDebug(Xt$1, "Initializing OfflineComponentProvider");
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(Xt$1, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t;
}
/**
...
*/ async function __PRIVATE_ensureOfflineComponents(e) {
	if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
		__PRIVATE_logDebug(Xt$1, "Using user provided OfflineComponentProvider");
		try {
	...
	} else __PRIVATE_logDebug(Xt$1, "Using default OfflineComponentProvider"), await __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
	return e._offlineComponents;
}
async function __PRIVATE_ensureOnlineComponents(e) {
	return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(Xt$1, "Using user provided OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(Xt$1, "Using default OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
}
...
/** Enables the network connection and re-enqueues all pending operations. */ function __PRIVATE_firestoreClientEnableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!0), function __PRIVATE_remoteStoreEnableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			return t.Ia.delete(0), __PRIVATE_enableNetworkInternal(t);
		}(n);
	}));
}
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.Ia.add(0), await __PRIVATE_disableNetworkInternal(t), t.Va.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e, t, n) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e, t, !0), i = new __PRIVATE_View(t, r.ks), s = i.ru(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
				...
				r.connection.qo || delete i.parent;
				const _ = (await r.jo("RunAggregationQuery", r.serializer.databaseId, o, i, 1)).filter(((e) => !!e.result));
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_addSnapshotsInSyncListener(e, t) {
		__PRIVATE_debugCast(e).Ca.add(t), t.next();
	}(await __PRIVATE_getEventManager(e), n))), () => {
		n.Nu(), e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_removeSnapshotsInSyncListener(e, t) {
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreGetNamedQuery(e, t) {
		const n = __PRIVATE_debugCast(e);
		return n.persistence.runTransaction("Get named query", "readonly", ((e) => n.Pi.getNamedQuery(e, t)));
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Yt$1 = "ComponentProvider", en = /* @__PURE__ */ new Map();
/**
...
* limitations under the License.
*/
var tn = "firestore.googleapis.com", nn = !0;
/**
...
var FirestoreSettingsImpl = class {
	constructor(e) {
		...
		__PRIVATE_validateIsNotUsedTogether("experimentalForceLongPolling", e.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", e.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!e.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = !1 : void 0 === e.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!e.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions(e.experimentalLongPollingOptions ?? {}), function __PRIVATE_validateLongPollingOptions(e) {
	...
	*/ _terminate() {
		...
		*/
		return function __PRIVATE_removeComponents(e) {
			const t = en.get(e);
			t && (__PRIVATE_logDebug(Yt$1, "Removing Datastore"), en.delete(e), t.terminate());
...
*/ function connectFirestoreEmulator(e, t, n, r = {}) {
	...
	if (!deepEqual(a, o) && (e._setSettings(a), r.mockUserToken)) {
		...
		if ("string" == typeof r.mockUserToken) t = r.mockUserToken, n = User.MOCK_USER;
			...
			if (!i) throw new FirestoreError(D.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			n = new User(i);
		}
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.Yu = [], this.ec = !1, this.tc = [], this.nc = null, this.rc = !1, this.sc = !1, this.oc = [], this.M_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this._c = () => {
			const e = getDocument();
			e && __PRIVATE_logDebug(rn, "Visibility state changed to " + e.visibilityState), this.M_.w_();
		}, this.ac = e;
		const t = getDocument();
	...
	*/ async lc() {
	...
	cc(e) {
		const t = this.ac.then((() => (this.rc = !0, e().catch(((e) => {
			this.nc = e, this.rc = !1;
...
function getFirestore(e, n) {
	const r = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : n || it, s = _getProvider(r, "firestore").getImmediate({ identifier: i });
	if (!s._initialized) {
...
function __PRIVATE_isWrite(e) {
	switch (e) {
		...
		case 3:
		case 4: return !1;
		default: throw fail(40011, { dataSource: e });
	}
}
/** A "context" object passed around while parsing user data. */ var __PRIVATE_ParseContextImpl = class __PRIVATE_ParseContextImpl {
	...
	*/
	constructor(e, t, n, r, i, s) {
		this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r, void 0 === i && this.Ac(), this.fieldTransforms = i || [], this.fieldMask = s || [];
	}
	get path() {
	...
	/** Returns a new context with the specified settings overwritten. */ i(e) {
...
*/ var __PRIVATE_UserDataReader = class {
	...
	/** Creates a new top-level parse context. */ I(e, t, n, r = !1) {
		return new __PRIVATE_ParseContextImpl({
			dataSource: e,
			methodName: t,
			targetDoc: n,
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.Sc.map(((e) => __PRIVATE_parseData(e, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.Sc.map(((e) => __PRIVATE_parseData(e, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
...
var __PRIVATE_NumericIncrementFieldValueImpl = class __PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
	...
	isEqual(e) {
		return e instanceof __PRIVATE_NumericIncrementFieldValueImpl && this.bc === e.bc;
	}
};
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
	...
	for (let e = 0; e < s.length; e += 2) _.push(__PRIVATE_fieldPathFromArgument(t, s[e])), a.push(s[e + 1]);
 ...
 /**
		...
		*/
		return function __PRIVATE_parseVectorValue(e, t) {
			const n = e instanceof VectorValue ? e.toArray() : e;
			return { mapValue: { fields: {
				[st]: { stringValue: at },
				[ut]: { arrayValue: { values: n.map(((e) => {
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
	if (t.search(_n) >= 0) throw __PRIVATE_createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, !1, void 0, n);
	try {
...
*/ var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
		const t = e.fields?.[ut].arrayValue?.values?.map(((e) => __PRIVATE_normalizeNumber(e.doubleValue)));
...
*/ function _internalAggregationQueryToProtoRunAggregationQueryRequest(e, t) {
	const n = __PRIVATE_mapToArray(t, ((e, t) => new __PRIVATE_AggregateImpl(t, e.aggregateType, e._internalFieldPath))), i = ensureFirestoreConfigured(__PRIVATE_cast(e.firestore, Firestore))._onlineComponents?.datastore.serializer;
...
var Ut = "@firebase/firestore", Ht = "4.14.0";
/**
* @license
* Copyright 2017 Google LLC
*
...
*/ var DocumentSnapshot$1 = class {
	...
	*/ data() {
		if (this._document) {
			if (this._converter) {
				const t = new QueryDocumentSnapshot$1(this._firestore, this._userDataWriter, this._key, this._document, null);
...
*/ var QueryFieldFilterConstraint = class QueryFieldFilterConstraint extends QueryConstraint {
	...
	*/
	...
	_parse(t) {
		...
		return function __PRIVATE_newQueryFilter(t, e, n, r, s, a, o) {
			let i;
			if (s.isKeyField()) {
				...
				if ("in" === a || "not-in" === a) {
					...
					i = { arrayValue: { values: e } };
				} else i = __PRIVATE_parseDocumentIdValue(r, t, o);
			} else "in" !== a && "not-in" !== a && "array-contains-any" !== a || __PRIVATE_validateDisjunctiveFilterElements(o, a), i = __PRIVATE_parseQueryValue(n, e, o, "in" === a || "not-in" === a);
	...
	*/
	...
	_apply(t) {
		const e = function __PRIVATE_newQueryOrderBy(t, e, n) {
			if (null !== t.startAt) throw new FirestoreError(D.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
			if (null !== t.endAt) throw new FirestoreError(D.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
			return new OrderBy(e, n);
...
function startAt(...t) {
	return QueryStartAtConstraint._create("startAt", t, !0);
}
function startAfter(...t) {
	return QueryStartAtConstraint._create("startAfter", t, !1);
}
/**
...
function endBefore(...t) {
	return QueryEndAtConstraint._create("endBefore", t, !1);
}
function endAt(...t) {
	return QueryEndAtConstraint._create("endAt", t, !0);
}
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
	if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(t, e, n, r, s) {
		...
		const a = [];
		for (const n of __PRIVATE_queryNormalizedOrderBy(t)) if (n.field.isKeyField()) a.push(__PRIVATE_refValue(e, r.key));
		else {
			const t = r.data.field(n.field);
			if (__PRIVATE_isServerTimestamp(t)) throw new FirestoreError(D.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field \"" + n.field + "\" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)");
			if (null === t) {
				const t = n.field.canonicalString();
				throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
			}
			a.push(t);
		}
	...
	}(t._query, t.firestore._databaseId, e, n[0]._document, r);
	{
		...
		return function __PRIVATE_newQueryBoundFromFields(t, e, n, r, s, a) {
			...
			if (s.length > o.length) throw new FirestoreError(D.INVALID_ARGUMENT, `Too many arguments provided to ${r}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
			const i = [];
			for (let a = 0; a < s.length; a++) {
				const c = s[a];
				if (o[a].field.isKeyField()) {
					if ("string" != typeof c) throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r}(), but got a ${typeof c}`);
					if (!__PRIVATE_isCollectionGroupQuery(t) && -1 !== c.indexOf("/")) throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
					const n = t.path.child(ResourcePath.fromString(c));
					...
					const t = __PRIVATE_parseQueryValue(n, r, c);
					i.push(t);
				}
			}
...
*/ function __PRIVATE_validateNewFieldFilter(t, e) {
	...
	if (null !== n) throw n === e.op ? new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
}
...
var __PRIVATE_LiteUserDataWriter = class extends AbstractUserDataWriter {
	...
	convertReference(t) {
		...
		return new DocumentReference(this.firestore, null, e);
	}
};
/**
* @license
...
*/ function getAggregateFromServer(t, e) {
	const n = __PRIVATE_cast(t.firestore, Firestore), r = ensureFirestoreConfigured(n), s = __PRIVATE_mapToArray(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
	return __PRIVATE_firestoreClientRunAggregateQuery(r, t._query, s).then(((e) => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, n) {
		return new AggregateQuerySnapshot(e, new __PRIVATE_ExpUserDataWriter(t), n);
	}(n, t, e)));
}
...
var __PRIVATE_SingleTabManagerImpl = class {
	...
	* @internal
	*/ _initialize(t) {
		this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = { build: (e) => new __PRIVATE_IndexedDbOfflineComponentProvider(e, t?.cacheSizeBytes, this.forceOwnership) };
	}
};
var __PRIVATE_MultiTabManagerImpl = class {
	...
	* @internal
	*/ _initialize(t) {
		this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = { build: (e) => new __PRIVATE_MultiTabOfflineComponentProvider(e, t?.cacheSizeBytes) };
	}
};
/**
...
*/ var DocumentSnapshot = class DocumentSnapshot extends DocumentSnapshot$1 {
	...
	*/ data(t = {}) {
		if (this._document) {
			if (this._converter) {
				const e = new QueryDocumentSnapshot(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
...
function documentSnapshotFromJSON(t, e, n) {
	if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
		...
		return new DocumentSnapshot(t, new __PRIVATE_LiteUserDataWriter(t), h, c, new SnapshotMetadata(!1, !1), n || null);
	}
}
/**
* A `QueryDocumentSnapshot` contains data read from a document in your
...
*/ var QuerySnapshot = class QuerySnapshot {
	...
	*/ docChanges(t = {}) {
		...
		return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function __PRIVATE_changesFromSnapshot(t, e) {
			...
			}
			{
				...
				return t._snapshot.docChanges.filter(((t) => e || 3 !== t.type)).map(((e) => {
					...
					let s = -1, a = -1;
					return 0 !== e.type && (s = n.indexOf(e.doc.key), n = n.delete(e.doc.key)), 1 !== e.type && (n = n.add(e.doc), a = n.indexOf(e.doc.key)), {
...
function querySnapshotFromJSON(t, e, n) {
	if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
		...
		const d = ViewSnapshot.fromInitialDocuments(i, h, __PRIVATE_documentKeySet(), !1, !1), p = new Query(t, n || null, i);
...
function __PRIVATE_resultChangeType(t) {
	switch (t) {
		...
		default: return fail(61501, { type: t });
	}
}
/**
...
*/ var Transaction = class extends Transaction$1 {
	...
	*/ get(t) {
		...
		return super.get(t).then(((t) => new DocumentSnapshot(this._firestore, n, e._key, t._document, new SnapshotMetadata(!1, !1), e.converter)));
	}
};
/**
...
*/ function runTransaction(t, e, n) {
	...
	(function __PRIVATE_validateTransactionOptions(t) {
		if (t.maxAttempts < 1) throw new FirestoreError(D.INVALID_ARGUMENT, "Max attempts must be at least 1");
	})(r);
	return __PRIVATE_firestoreClientTransaction(ensureFirestoreConfigured(t), ((n) => e(new Transaction(t, n))), r);
}
/**
* @license
* Copyright 2020 Google LLC
...
*/ function getDocFromCache(t) {
	...
	return __PRIVATE_firestoreClientGetDocumentFromLocalCache(n, t._key).then(((n) => new DocumentSnapshot(e, r, t._key, n, new SnapshotMetadata(null !== n && n.hasLocalMutations, !0), t.converter)));
}
/**
...
*/ function getDocFromServer(t) {
	t = __PRIVATE_cast(t, DocumentReference);
	const e = __PRIVATE_cast(t.firestore, Firestore);
	return __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(ensureFirestoreConfigured(e), t._key, { source: "server" }).then(((n) => __PRIVATE_convertToDocSnapshot(e, t, n)));
}
/**
...
function setDoc(t, e, n) {
	...
	return executeWrite(r, [__PRIVATE_parseSetData(__PRIVATE_newUserDataReader(r), "setDoc", t._key, s, null !== t.converter, n).toMutation(t._key, Precondition.none())]);
}
function updateDoc(t, e, n, ...r) {
	t = __PRIVATE_cast(t, DocumentReference);
	const s = __PRIVATE_cast(t.firestore, Firestore), o = __PRIVATE_newUserDataReader(s);
	let i;
	i = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(o, "updateDoc", t._key, e, n, r) : __PRIVATE_parseUpdateData(o, "updateDoc", t._key, e);
...
* the document.
*/ function addDoc(t, e) {
	const n = __PRIVATE_cast(t.firestore, Firestore), r = doc(t), s = __PRIVATE_applyFirestoreDataConverter(t.converter, e);
	return executeWrite(n, [__PRIVATE_parseSetData(__PRIVATE_newUserDataReader(t.firestore), "addDoc", r._key, s, null !== t.converter, {}).toMutation(r._key, Precondition.exists(!1))]).then((() => r));
}
function onSnapshot(t, ...e) {
	...
	if (t instanceof DocumentReference) i = __PRIVATE_cast(t.firestore, Firestore), c = __PRIVATE_newQueryForPath(t._key.path), o = {
		...
		i = __PRIVATE_cast(n.firestore, Firestore), c = n._query;
	...
	return __PRIVATE_firestoreClientListen(ensureFirestoreConfigured(i), c, s, o);
}
function onSnapshotResume(t, e, ...n) {
	const r = getModularInstance(t), s = function __PRIVATE_normalizeSnapshotJsonFields(t) {
		const e = {
			bundle: "",
			bundleName: "",
			bundleSource: ""
		...
		*/
		return function __PRIVATE_onSnapshotQuerySnapshotBundle(t, e, n, r, s) {
			...
			return loadBundle(t, e.bundle).then((() => namedQuery(t, e.bundleName))).then(((t) => {
				if (t && !o) s && t.withConverter(s), a = onSnapshot(t, n || {}, r);
	...
	if ("DocumentSnapshot" === s.bundleSource) {
		...
		return function __PRIVATE_onSnapshotDocumentSnapshotBundle(t, e, n, r, s) {
			...
			return loadBundle(t, e.bundle).then((() => {
				if (!o) a = onSnapshot(new DocumentReference(t, s || null, DocumentKey.fromPath(e.bundleName)), n || {}, r);
			})).catch(((t) => (r.error && r.error(t), () => {}))), () => {
				o || (o = !0, a && a());
			};
		}(r, s, a, t, n[o]);
...
function onSnapshotsInSync(t, e) {
	t = __PRIVATE_cast(t, Firestore);
	return __PRIVATE_firestoreClientAddSnapshotsInSyncListener(ensureFirestoreConfigured(t), __PRIVATE_isPartialObserver(e) ? e : { next: e });
}
/**
* Locally writes `mutations` on the async queue.
* @internal
*/ function executeWrite(t, e) {
	return __PRIVATE_firestoreClientWrite(ensureFirestoreConfigured(t), e);
}
/**
...
*/ function __PRIVATE_convertToDocSnapshot(t, e, n) {
	...
	return new DocumentSnapshot(t, new __PRIVATE_ExpUserDataWriter(t), e._key, r, new SnapshotMetadata(n.hasPendingWrites, n.fromCache), e.converter);
}
	...
	return __PRIVATE_firestoreClientSetIndexConfiguration(n, function __PRIVATE_parseIndexes(t) {
		const e = "string" == typeof t ? function __PRIVATE_tryParseJson(t) {
			try {
				...
				throw new FirestoreError(D.INVALID_ARGUMENT, "Failed to parse JSON: " + t?.message);
			}
		}(t) : t, n = [];
...
*/ function getPersistentCacheIndexManager(t) {
	...
	const e = Kt.get(t);
	if (e) return e;
	if ("persistent" !== ensureFirestoreConfigured(t)._uninitializedComponentsProvider?._offline.kind) return null;
...
*/ function deleteAllPersistentCacheIndexes(t) {
	__PRIVATE_firestoreClientDeleteAllFieldIndexes(ensureFirestoreConfigured(t._firestore)).then(((t) => __PRIVATE_logDebug("deleting all persistent cache indexes succeeded"))).catch(((t) => __PRIVATE_logWarn("deleting all persistent cache indexes failed", t)));
}
function __PRIVATE_setPersistentCacheIndexAutoCreationEnabled(t, e) {
	__PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(ensureFirestoreConfigured(t._firestore), e).then(((t) => __PRIVATE_logDebug(`setting persistent cache index auto creation isEnabled=${e} succeeded`))).catch(((t) => __PRIVATE_logWarn(`setting persistent cache index auto creation isEnabled=${e} failed`, t)));
}
/**
